...
describe('TimeLine.vue', () => {
  test('create', () => {
    ...
    const contentWrappers = wrapper.findAll('.k-timeline-item__content')
  ...
  test('placement', () => {
    ...
    const timestampWrapper = wrapper.findAll('.k-timeline-item__timestamp')[0]
  ...
  test('hide-timestamp', () => {
    ...
    const timestampWrappers = wrapper.findAll('.k-timeline-item__timestamp')
  ...
  test('color', () => {
    ...
    const vm = wrapper.vm
    const nodeKm = vm.$el.querySelector('.k-timeline-item__node')

    expect(nodeKm.style.backgroundColor).toEqual('rgb(255, 0, 0)')
  })
  ...
  test('type', () => {
    ...
    const nodeWrapper = wrapper.find('.k-timeline-item__node')

    expect(nodeWrapper.classes('k-timeline-item__node--primary')).toBe(true)
  })
  ...
  test('size', () => {
    ...
    expect(nodeWrapper.classes('k-timeline-item__node--large')).toBe(true)
  })
  ...
  test('icon', () => {
    ...
    expect(wrapper.find('.k-timeline-item__icon').exists()).toBe(true)
  ...
  test('dot', () => {
    ...
    const dotWrapper = wrapper.find('.k-timeline-item__dot')

    expect(dotWrapper.text()).toEqual('dot')
    expect(wrapper.find('.k-timeline-item__node').exists()).toBe(false)
  })
  ...
  test('center', () => {
    ...
    const timestampWrappers = wrapper.findAll('.k-timeline-item')

    expect(timestampWrappers[1].classes()).toContain('k-timeline-item__center')
  })
})
