...
import type { KRovingFocusGroupProps } from './roving-focus-group'

type EventHandler<T = Event> = (e: T) => void

export type RovingGroupInjectionContext = {
  currentTabbedId: Ref<string | null>
  dir: Ref<KRovingFocusGroupProps['dir']>
  loop: Ref<KRovingFocusGroupProps['loop']>
  orientation: Ref<KRovingFocusGroupProps['orientation']>
  tabIndex: Ref<number>
