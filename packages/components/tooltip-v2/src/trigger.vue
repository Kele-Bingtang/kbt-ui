...
watch(triggerRef, (triggerK, previousTriggerK) => {
  setEvents(triggerK, events, 'addEventListener')
  setEvents(previousTriggerK, events, 'removeEventListener')

  if (triggerK) {
    triggerK.setAttribute('aria-describedby', contentId.value)
  }
})
