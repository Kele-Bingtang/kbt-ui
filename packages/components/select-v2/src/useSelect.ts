...
import { useFocusController, useLocale, useNamespace } from '@kbt-ui/hooks'
...
import type KTooltip from '@kbt-ui/components/tooltip'
...
const useSelect = (props: ISelectV2Props, emit) => {
  ...
  const tooltipRef = ref<InstanceType<typeof KTooltip> | null>(null)
  const tagTooltipRef = ref<InstanceType<typeof KTooltip> | null>(null)
