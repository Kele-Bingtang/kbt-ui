...
import Form from '@kbt-ui/components/form'
...
describe('Button.vue', () => {
  ...
  it('tag', () => {
    const link = 'https://github.com/kbt-ui/kbt-ui'
    const wrapper = mount(() => (
      // @ts-ignore
...
describe('Button Group', () => {
  ...
  it('button group reactive size', async () => {
    ...
    expect(wrapper.classes()).toContain('k-button-group')
    expect(
      wrapper.findAll('.k-button-group button.k-button--small').length
    ).toBe(2)
    ...
    expect(
      wrapper.findAll('.k-button-group button.k-button--large').length
    ).toBe(2)
  })
  ...
  it('button group type', async () => {
    ...
    expect(wrapper.classes()).toContain('k-button-group')
    expect(
      wrapper.findAll('.k-button-group button.k-button--primary').length
    ).toBe(1)
    expect(
      wrapper.findAll('.k-button-group button.k-button--warning').length
    ).toBe(1)
  })
  ...
  it('add space in two Chinese characters', async () => {
    ...
    expect(wrapper.find('.k-button span').text()).toBe('中文')
    expect(wrapper.find('.k-button span').classes()).toContain(
      'k-button__text--expand'
    )
  })
  ...
  it('should use props of form', async () => {
    ...
    expect(btn.classes()).toContain('k-button--large')
  ...
  it('should use size of form-item', async () => {
    ...
    const btn = wrapper.findComponent(Button)
    expect(btn.classes()).toContain('k-button--small')
  })
})
