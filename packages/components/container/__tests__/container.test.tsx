...
import { getCssVariable } from '@kbt-ui/test-utils/dom'
...
describe('Header', () => {
  test('create header', () => {
    ...
    expect(wrapper.classes()).toContain('k-header')
  })

  test('header height', () => {
    const wrapper = mount(() => <Header height="100px" />)
    const vm = wrapper.vm
    expect(getCssVariable(vm.$el, '--k-header-height')).toEqual('100px')
  })
})
...
describe('Aside', () => {
  test('aside create', () => {
    ...
    expect(wrapper.classes()).toContain('k-aside')
  })

  test('aside width', () => {
    const wrapper = mount(() => <Aside width="200px" />)
    const vm = wrapper.vm
    expect(getCssVariable(vm.$el, '--k-aside-width')).toEqual('200px')
  })
})
...
describe('Main', () => {
  test('main create', () => {
    ...
    expect(wrapper.classes()).toContain('k-main')
  })
})
...
describe('Footer', () => {
  test('footer create', () => {
    ...
    expect(wrapper.classes()).toContain('k-footer')
  })

  test('footer height', () => {
    const wrapper = mount(() => <Footer height="100px" />)
    const vm = wrapper.vm
    expect(getCssVariable(vm.$el, '--k-footer-height')).toEqual('100px')
  })
})
