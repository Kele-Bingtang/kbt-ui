...
const TITLE_CLASS = '.k-statistic__head'
const CONTENT_CLASS = '.k-statistic__content'
const PERFIX_CLASS = '.k-statistic__prefix'
const SUFFIX_CLASS = '.k-statistic__suffix'
