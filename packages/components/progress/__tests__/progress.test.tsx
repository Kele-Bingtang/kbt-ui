...
describe('Progress.vue', () => {
  test('percent', () => {
    ...
    expect(wrapper.find('.k-progress__text').text()).toBe('66%')
    expect(wrapper.find('.k-progress-bar__inner').attributes('style')).toBe(
  ...
  test('text inside', () => {
    ...
    expect(wrapper.classes()).toContain('k-progress--text-inside')
  })

  test('stroke width', () => {
    const wrapper = mount(() => <Progress strokeWidth={7} />)

    expect(wrapper.find('.k-progress-bar__outer').attributes('style')).toBe(
      'height: 7px;'
    )
  })
  ...
  test('show text', () => {
    ...
    expect(wrapper.find('.k-progress__text').exists()).toBe(false)
  })

  test('circle', () => {
    const wrapper = mount(() => <Progress type="circle" />)

    expect(wrapper.classes()).toContain('k-progress--circle')
  })

  test('dashboard', () => {
    const wrapper = mount(() => <Progress type="dashboard" />)

    expect(wrapper.classes()).toContain('k-progress--dashboard')
  })

  test('width', () => {
    const wrapper = mount(() => <Progress type="circle" width={120} />)

    expect(wrapper.find('.k-progress-circle').attributes('style')).toBe(
  ...
  test('color', () => {
    ...
    expect(
      wrapper.find('.k-progress-bar__inner').attributes('style')
  ...
  test('striped', () => {
    ...
    expect(wrapper.find('.k-progress-bar__inner--striped').exists()).toBe(true)
  })
  ...
  test('striped flow', () => {
    ...
    expect(wrapper.find('.k-progress-bar__inner--striped').exists()).toBe(true)
    expect(wrapper.find('.k-progress-bar__inner--striped-flow').exists()).toBe(
      true
    )
  })
  ...
  test('format', () => {
    ...
    expect(wrapper.find('.k-progress__text').text()).toBe('占比100%')
  })
  ...
  test('slot', () => {
    ...
    expect(wrapper.find('.k-progress__text').text()).toBe('自定义内容')
  })
})
