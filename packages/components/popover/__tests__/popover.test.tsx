...
import { usePopperContainerId, useZIndex } from '@kbt-ui/hooks'
...
describe('Popover.vue', () => {
  ...
  it('should be able to emit after-enter and after-leave', async () => {
    ...
    await nextTick()
    const trigger$ = wrapper.findComponent(KPopperTrigger)
  ...
  it('test visible controlled mode trigger invalid', async () => {
    ...
    const trigger$ = wrapper.findComponent(KPopperTrigger)
    const triggerK = trigger$.find('.k-tooltip__trigger')
    const popoverDom: HTMLElement = document.querySelector('.k-popper')!
