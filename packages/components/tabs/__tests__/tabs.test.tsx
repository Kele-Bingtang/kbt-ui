...
import type { TabsPaneContext } from '@kbt-ui/components/tabs'
...
describe('Tabs.vue', () => {
  test('create', async () => {
    ...
    const navItemsWrapper = navWrapper.findAll('.k-tabs__item')

    expect(navItemsWrapper[0].classes('is-active')).toBe(true)
    expect(panesWrapper[0].classes('k-tab-pane')).toBe(true)
  ...
  test('active-name', async () => {
    ...
    expect(panesWrapper[1].classes('k-tab-pane')).toBe(true)
  ...
  test('card', async () => {
    ...
    const tabsWrapper = wrapper.findComponent(Tabs)
    expect(tabsWrapper.classes('k-tabs--card')).toBe(true)
  })
  ...
  test('border card', async () => {
    ...
    const tabsWrapper = wrapper.findComponent(Tabs)
    expect(tabsWrapper.classes('k-tabs--border-card')).toBe(true)
  })
  ...
  test('dynamic', async () => {
    ...
    let navItemsWrapper = navWrapper.findAll('.k-tabs__item')
    ...
    navItemsWrapper = navWrapper.findAll('.k-tabs__item')
  ...
  test('editable', async () => {
    ...
    await wrapper.find('.k-tabs__new-tab').trigger('click')
  ...
  test('tab order', async () => {
    ...
    const items = wrapper.findAll('.k-tabs__item')
  ...
  test('tab-position', async () => {
    ...
    expect(tabsWrapper.classes('k-tabs--left')).toBe(true)
    expect(tabsWrapper.find('.k-tabs__header').classes('is-left')).toBe(true)
    expect(tabsWrapper.find('.k-tabs__nav-wrap').classes('is-left')).toBe(true)
    expect(tabsWrapper.find('.k-tabs__nav').classes('is-left')).toBe(true)
    expect(tabsWrapper.find('.k-tabs__active-bar').classes('is-left')).toBe(
      true
    )
    expect(tabsWrapper.find('.k-tabs__item').classes('is-left')).toBe(true)
  })
  ...
  test('stretch', async () => {
    ...
    expect(tabsWrapper.find('.k-tabs__nav').classes('is-stretch')).toBe(true)

    tabPosition.value = 'left'
    await nextTick()

    expect(tabsWrapper.find('.k-tabs__nav').classes('is-stretch')).toBe(false)
  })
  ...
  test('tab active bar offset', async () => {
    ...
    await nextTick()
    expect(tabsWrapper.find('.k-tabs__active-bar').attributes().style).toMatch(
      'translateX(300px)'
    )
  ...
  test('should work with lazy', async () => {
    ...
    expect(wrapper.findAll('.k-tab-pane').length).toBe(3)

    await navItemsWrapper[3].trigger('click')

    expect(wrapper.findAll('.k-tab-pane').length).toBe(4)
  })
