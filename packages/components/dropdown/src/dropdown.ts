// @ts-nocheck
import { buildProps, definePropType, iconPropType } from '@kbt-ui/utils'
import { EVENT_CODE } from '@kbt-ui/constants'
import { createCollectionWithScope } from '@kbt-ui/components/collection'
import {
  useTooltipContentProps,
  useTooltipTriggerProps,
} from '@kbt-ui/components/tooltip'

import type { Options } from '@popperjs/core'
import type { ButtonProps, ButtonType } from '@kbt-ui/components/button'
import type { Placement } from '@kbt-ui/components/popper'
import type { ComponentInternalInstance, ComputedRef } from 'vue'
import type { Nullable } from '@kbt-ui/utils'

export interface IKDropdownInstance {
  ...
  triggerKm?: ComputedRef<Nullable<HTMLButtonElement>>
}
