...
describe('Slider', () => {
  ...
  it('sizes', () => {
    ...
    expect(wrapper.find('.k-slider--small').exists()).toBe(true)
  })
  ...
  it('show tooltip', () => {
    ...
    const slider = wrapper.findComponent({ name: 'KSliderButton' })
  ...
  it('hide tooltip', () => {
    ...
    const tooltip = wrapper.findComponent({ name: 'KTooltip' }).vm
  ...
  describe('drag', () => {
    it('horizontal', async () => {
      ...
      vi.spyOn(
        wrapper.find('.k-slider__runway').element,
        'clientWidth',
        'get'
  ...
  it('step', async () => {
    ...
    const mockClientWidth = vi
      .spyOn(wrapper.find('.k-slider__runway').element, 'clientWidth', 'get')
      .mockImplementation(() => 200)
    const slider = wrapper.findComponent({ name: 'KSliderButton' })
    await nextTick()
  ...
  it('click', async () => {
    ...
    const mockClientWidth = vi
      .spyOn(wrapper.find('.k-slider__runway').element, 'clientWidth', 'get')
      .mockImplementation(() => 200)
    const slider = wrapper.findComponent({ name: 'KSlider' })
  ...
  it('show input', async () => {
    ...
    const increaseButton = wrapper.find('.k-input-number__increase')
  ...
  it('show stops', () => {
    ...
    const stops = wrapper.findAll('.k-slider__stop')
  ...
  it('vertical mode', async () => {
    ...
    const mockClientHeight = vi
      .spyOn(wrapper.find('.k-slider__runway').element, 'clientHeight', 'get')
      .mockImplementation(() => 200)
    const slider = wrapper.getComponent({ name: 'KSlider' })
    slider.vm.onSliderClick(new MouseEvent('mousedown', { clientX: 100 }))
    await nextTick()
    expect(value.value > 0).toBeTruthy()
  ...
  describe('range', () => {
    it('basic ranged slider', () => {
      ...
      const sliders = wrapper.findAllComponents({ name: 'KSliderButton' })
    ...
    it('marks', async () => {
      ...
      await nextTick()
      const stops = wrapper.findAll('.k-slider__marks-stop.k-slider__stop')
      const marks = wrapper.findAll('.k-slider__marks .k-slider__marks-text')
  ...
  describe('form item accessibility integration', () => {
    it('automatic id attachment', async () => {
      ...
      const sliderButton = wrapper.find('.k-slider__button-wrapper')
    ...
    it('range with automatic id attachment', async () => {
      ...
      const formItem = wrapper.find('[data-test-ref="item"]')
      const formItemLabel = formItem.find('.k-form-item__label')
      const sliderWrapper = wrapper.find('.k-slider')
      expect(formItem.attributes().role).toBeFalsy()
