...
export declare interface MessageBoxState {
  ...
  modalFade: boolean
  modalClass: string
  // refer to: https://github.com/KemeFE/element/commit/2999279ae34ef10c373ca795c87b020ed6753eed
...
export interface KMessageBoxOptions {
  /**
  ...
  title?: string | KMessageBoxOptions
...
export type KMessageBoxShortcutMethod = ((
  message: KMessageBoxOptions['message'],
  title: KMessageBoxOptions['title'],
  options?: KMessageBoxOptions,
...
export interface IKMessageBox {
  ...
  alert: KMessageBoxShortcutMethod

  /** Show a confirm message box */
  confirm: KMessageBoxShortcutMethod

  /** Show a prompt message box */
  prompt: KMessageBoxShortcutMethod
