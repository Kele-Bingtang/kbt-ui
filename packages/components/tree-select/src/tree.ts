...
import { escapeStringRegexp, isFunction } from '@kbt-ui/utils'
...
import type Node from '@kbt-ui/components/tree/src/model/node'
import type { TreeNodeData } from '@kbt-ui/components/tree/src/tree.type'
import type { TreeInstance } from '@kbt-ui/components/tree'
...
export const useTree = (
  ...
  { attrs, slots, emit },
  {
    ...
    select: Ref<InstanceType<typeof KSelect> | undefined>
  ...
  return {
    ...pick(toRefs(props), Object.keys(KTree.props)),
    ...attrs,
    nodeKey: key,
