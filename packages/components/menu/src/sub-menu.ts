...
import { buildProps, iconPropType, isString, throwError } from '@kbt-ui/utils'
...
export default defineComponent({
  ...
  setup(props, { slots, expose }) {
    ...
    const vPopper = ref<InstanceType<typeof KTooltip> | null>(null)
    ...
    return () => {
      ...
      // temporarily mark KPopper as any due to type inconsistency.
