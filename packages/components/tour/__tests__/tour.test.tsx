...
describe('Tour.vue', () => {
  ...
  test('basic', () => {
    ...
    expect(document.querySelector('.k-tour__title')?.innerHTML).toEqual(
      'cover title'
    )
    expect(document.querySelector('.k-tour__body span')?.innerHTML).toEqual(
      'cover description.'
    )
  })
  ...
  test('no mask', () => {
    ...
    expect(document.querySelector('.k-tour-mask')?.innerHTML).toBeFalsy()
  })
  ...
  test('custom indicator', () => {
    ...
    expect(document.querySelector('.k-tour-indicators')?.innerHTML).toBe(
      '1 / 1'
    )
  })
  ...
  test('primary', () => {
    ...
    expect(document.querySelector('.k-tour.k-tour--primary')).toBeTruthy()
  })
  ...
  test('no target', () => {
    ...
    const style = getComputedStyle(document.querySelector('.k-tour__content')!)
