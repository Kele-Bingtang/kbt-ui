...
describe('Breadcrumb.vue', () => {
  it('separator', () => {
    ...
    expect(wrapper.find('.k-breadcrumb__separator').text()).toBe('?')
  })
  ...
  it('to', () => {
    ...
    expect(wrapper.find('.k-breadcrumb__inner').classes()).toContain('is-link')
  })

  it('single', () => {
    const wrapper = _mount(() => <BreadcrumbItem>A</BreadcrumbItem>)
    expect(wrapper.find('.k-breadcrumb__inner').text()).toBe('A')
    expect(wrapper.find('.k-breadcrumb__separator').text()).toBe('')
  })
  ...
  describe('BreadcrumbItem', () => {
    ...
    it('click event', async () => {
      ...
      await wrapper.find('.k-breadcrumb__inner').trigger('click')
