...
import { BAR_MAP } from '@kbt-ui/components/scrollbar'
...
const ScrollBar = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const attachEvents = () => {
      ...
      thumbK.addEventListener('touchmove', onMouseMove)
      thumbK.addEventListener('touchend', onMouseUp)
    }
    ...
    const detachEvents = () => {
      ...
      thumbK.removeEventListener('touchmove', onMouseMove)
      thumbK.removeEventListener('touchend', onMouseUp)
    }
