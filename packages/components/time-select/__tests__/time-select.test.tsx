...
import Select from '@kbt-ui/components/select'
...
describe('TimeSelect', () => {
  it('create', async () => {
    ...
    const outerInput = wrapper.find('.k-select')
  ...
  it('set value update', async () => {
    ...
    expect(wrapper.findComponent({ name: 'KTimeSelect' }).vm.value).toBe(
      '10:30'
    )
  ...
  it('update value', async () => {
    ...
    await nextTick()
    const vm = wrapper.findComponent({ name: 'KTimeSelect' }).vm
  ...
  it('ref focus', async () => {
    ...
    const popperK = document.querySelector('.k-select__popper')
  ...
  it('set format', async () => {
    ...
    await nextTick()
    const option = document.querySelector('.k-select-dropdown__item')
