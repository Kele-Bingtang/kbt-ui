...
describe('TableV2.vue', () => {
  test('slots cell', async () => {
    ...
    expect(wrapper.find('.k-table-v2').exists()).toBe(true)
    const cell = wrapper.findAll('.k-table-v2__row-cell')

    expect(cell[0].find('.k-table-v2__cell-text').exists()).toBe(false)
    ...
    expect(cell[1].find('.k-table-v2__cell-text').exists()).toBe(true)
    expect(cell[1].find('.k-table-v2__cell-text').text()).toBe('Row 0 - Col 1')
  })
  ...
  test('slots header-cell', async () => {
    ...
    expect(wrapper.find('.k-table-v2').exists()).toBe(true)
    const cell = wrapper.findAll('.k-table-v2__header-cell')
    expect(cell[0].find('.k-table-v2__header-cell-text').exists()).toBe(false)
    expect(cell[0].find('span').exists()).toBe(true)
    expect(cell[0].find('span').text()).toBe(customText)

    expect(cell[1].find('span').exists()).toBe(false)
    expect(cell[1].find('.k-table-v2__header-cell-text').exists()).toBe(true)
    expect(cell[1].find('.k-table-v2__header-cell-text').text()).toBe(
      'Column 1'
    )
  })
  ...
  test('slots empty', async () => {
    ...
    let defaultEmpty = wrapper.find('.k-empty')
    ...
    defaultEmpty = wrapper.find('.k-empty')
  ...
  test('slots cell scope', async () => {
    ...
    expect(wrapper.find('.k-table-v2').exists()).toBe(true)
    const cell = wrapper.find('.k-table-v2__row-cell')
  ...
  test('slots header-cell scope', async () => {
    ...
    expect(wrapper.find('.k-table-v2').exists()).toBe(true)
    const cell = wrapper.find('.k-table-v2__header-cell')
    expect(cell.exists()).toBe(true)
    expect(cell.find('span').text()).toBe(
