...
import { getStyle } from '@kbt-ui/utils'
import { rAF } from '@kbt-ui/test-utils/tick'
import { KMessage } from '..'
import Message from '../src/method'

const selector = '.k-message'
...
describe('Message on command', () => {
  ...
  describe('context inheritance', () => {
    it('should globally inherit context correctly', () => {
      expect(KMessage._context).toBe(null)
      const testContext = {
        config: {
          globalProperties: {},
        },
      ...
      KMessage.install?.(testContext as any)
      expect(KMessage._context).not.toBe(null)
      expect(KMessage._context).toBe(testContext._context)
      // clean up
      KMessage._context = null
    })
  })
})
