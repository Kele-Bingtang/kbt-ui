...
describe('InputNumber.vue', () => {
  ...
  test('min', async () => {
    ...
    wrapper.find('.k-input-number__decrease').trigger('mousedown')
  ...
  test('max', async () => {
    ...
    expect(wrapper.find('input').element.value).toEqual('3')
    wrapper.find('.k-input-number__increase').trigger('mousedown')
    document.dispatchEvent(mouseup)
    await nextTick()
    expect(wrapper.find('input').element.value).toEqual('3')
  })
  ...
  test('value decimals miss prop precision', async () => {
    ...
    const elInputNumber = wrapper.findComponent({ name: 'KInputNumber' }).vm
  ...
  test('readonly', async () => {
    ...
    wrapper.find('.k-input__inner').trigger('focus')
    await nextTick()
  ...
  test('controls', async () => {
    ...
    expect(wrapper.find('.k-input-number__increase').exists()).toBe(false)
    expect(wrapper.find('.k-input-number__decrease').exists()).toBe(false)
  })
  ...
  test('clear with :value-on-clear="null"', async () => {
    ...
    const elInput = wrapper.findComponent({ name: 'KInputNumber' }).vm
  ...
  describe('form item accessibility integration', () => {
    test('automatic id attachment', async () => {
      ...
      const innerInput = wrapper.find('.k-input__inner')
