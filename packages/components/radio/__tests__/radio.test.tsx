...
describe('Radio', () => {
  test('create', async () => {
    ...
    expect(wrapper.classes()).toContain('k-radio')
...
describe('Radio group', () => {
  it('create', async () => {
    ...
    await nextTick()
    const [radio1, radio2] = wrapper.findAll('.k-radio')
  ...
  it('id auto derive', async () => {
    ...
    const id1 = wrapper1.find('.k-radio').find('input').attributes('name')
    const id2 = wrapper2.find('.k-radio').find('input').attributes('name')
  ...
  it('change event', async () => {
    ...
    const radio2 = wrapper.findAll('.k-radio').at(1)
    await radio2?.trigger('click')
    await nextTick()
  ...
  it('disabled when children is radio button', async () => {
    ...
    const [radio1, radio2] = wrapper.findAll('.k-radio-button')
...
describe('Radio Button', () => {
  ...
  it('custom color', () => {
    ...
    const radio1 = wrapper.find('.k-radio-button')
  ...
  it('change event', async () => {
    ...
    const radio2 = wrapper.findAll('.k-radio-button').at(1)
    await radio2?.trigger('click')
    expect(radio.value).toEqual(6)
  })
  it('change event only triggers on user input', async () => {
  ...
  it('size', () => {
    ...
    expect(wrapper.findAll('.k-radio-button--large').length).toBe(3)
  })

  describe('form item accessibility integration', () => {
    test('single radio group in form item', async () => {
      const wrapper = mount(() => (
        <KFormItem ref="item" label="Test">
