...
import { usePopper } from '@kbt-ui/hooks'
import { POPPER_INJECTION_KEY } from '../constants'
import { buildPopperOptions, unwrapMeasurableK } from '../utils'

import type { Modifier } from '@popperjs/core'
import type { PartialOptions } from '@kbt-ui/hooks'
...
export const usePopperContent = (props: PopperContentProps) => {
  ...
  const computedReference = computed(
    () => unwrapMeasurableK(props.referenceK) || unref(triggerRef)
  )
