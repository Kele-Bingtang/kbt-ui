...
describe('<KTooltipContent />', () => {
  ...
  const createComponent = (props = {}, provides = {}) => {
    const wrapper = mount(
      {
        setup() {
          ...
          return () => <KTooltipContent {...props}>{AXIOM}</KTooltipContent>
        },
      },
      {
        global: {
    ...
    return wrapper.findComponent(KTooltipContent)
  }
