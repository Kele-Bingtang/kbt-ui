...
import KTooltipTrigger from '../src/trigger.vue'
...
describe('<KTooltipTrigger />', () => {
  ...
  const createComponent = (props = {}) =>
    mount(
      {
        setup() {
          return () => <KTooltipTrigger {...props}>{AXIOM}</KTooltipTrigger>
        },
      },
      {
        global: {
          provide: defaultProvide,
          stubs: ['KPopperTrigger'],
        },
  ...
  describe('trigger event', () => {
    describe('controlled', () => {
      it('should not trigger anything when tooltip is controlled', async () => {
        ...
        const { vm } = wrapper.findComponent(KTooltipTrigger) as VueWrapper<any>
