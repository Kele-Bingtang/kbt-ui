...
import { useFormItem } from '@kbt-ui/components/form'
import { debugWarn } from '@kbt-ui/utils'
import { checkboxGroupContextKey } from '../constants'

import type { useFormItemInputId } from '@kbt-ui/components/form'
...
export const useCheckboxEvent = (
  ...
  async function onClickRoot(e: MouseEvent) {
    ...
    if (!hasOwnLabel.value && !isDisabled.value && isLabeledByFormItem.value) {
      // fix: https://github.com/kbt-ui/kbt-ui/issues/9981
