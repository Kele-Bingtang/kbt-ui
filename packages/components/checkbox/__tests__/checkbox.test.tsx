...
describe('Checkbox', () => {
  test('create', async () => {
    ...
    expect(wrapper.classes()).toContain('k-checkbox')
  ...
  test('label set to number 0', async () => {
    ...
    expect(wrapper.find('.k-checkbox__label').text()).toBe('0')
  })
  ...
  test('label', async () => {
    ...
    const checkbox = wrapper.find('.k-checkbox')
    await checkbox.trigger('click')
...
describe('check-button', () => {
  test('create', async () => {
    ...
    expect(wrapper.classes()).toContain('k-checkbox-button')
    await wrapper.trigger('click')
    expect(wrapper.classes()).toContain('is-checked')
    await wrapper.trigger('click')
    expect(wrapper.classes('is-checked')).toBe(false)
  ...
  test('button group props', () => {
    ...
    expect(checkbox.classes()).contains('is-checked')
    expect(
      checkbox.find('.k-checkbox-button__inner').attributes('style')
  ...
  test('button group tag', () => {
    ...
    expect(wrapper.find('tr').classes('k-checkbox-group')).toBeTruthy()
  })
  ...
  describe('checked prop', () => {
    ...
    test('checked', () => {
      ...
      expect(wrapper.find('.k-checkbox').classes()).contains('is-checked')
    })
  })
  ...
  describe('form item accessibility integration', () => {
    test('checkbox, no label, automatic label attachment', async () => {
      ...
      const formItem = await wrapper.findComponent(KFormItem)
      const checkbox = await wrapper.findComponent(Checkbox)
      const formItemLabel = formItem.find('.k-form-item__label')
      const checkboxInput = checkbox.find('.k-checkbox__original')
    ...
    test('checkbox with label, form item is group', async () => {
      ...
      const formItem = await wrapper.findComponent(KFormItem)
      const checkbox = await wrapper.findComponent(Checkbox)
      const checkboxLabel = checkbox.find('.k-checkbox__label')
      const checkboxInput = checkbox.find('.k-checkbox__original')
