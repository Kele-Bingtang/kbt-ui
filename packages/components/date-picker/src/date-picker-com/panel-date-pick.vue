...
import {
  ...
  extractDateFormat,
  extractTimeFormat,
} from '@kbt-ui/components/time-picker'
import { KIcon } from '@kbt-ui/components/icon'
import { isArray, isFunction } from '@kbt-ui/utils'
...
import { TOOLTIP_INJECTION_KEY } from '@kbt-ui/components/tooltip'
...
const handleDatePick = async (value: DateTableEmits, keepOpen?: boolean) => {
  if (selectionMode.value === 'date') {
    ...
    // fix: https://github.com/kbt-ui/kbt-ui/issues/14728
