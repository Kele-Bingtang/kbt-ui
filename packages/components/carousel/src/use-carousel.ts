...
import { debugWarn, flattedChildren, isString } from '@kbt-ui/utils'
import { useOrderedChildren } from '@kbt-ui/hooks'
...
export const useCarousel = (
  ...
  function PlaceholderItem() {
    // fix: https://github.com/kbt-ui/kbt-ui/issues/12139
    const defaultSlots = slots.default?.()
    if (!defaultSlots) return null

    const flatSlots = flattedChildren(defaultSlots)

    const carouselItemsName = 'KCarouselItem'
