...
import { useAttrs, useId, useNamespace } from '@kbt-ui/hooks'
import { isArray, throwError } from '@kbt-ui/utils'
import {
  CHANGE_EVENT,
  INPUT_EVENT,
  UPDATE_MODEL_EVENT,
...
const COMPONENT_NAME = 'KAutocomplete'
defineOptions({
  name: COMPONENT_NAME,
  inheritAttrs: false,
})
...
const handleBlur = (evt: FocusEvent) => {
  setTimeout(() => {
    // validate current focus event is inside k-tooltip-content
...
defineExpose({
  ...
  loading,
  /** @description k-input component instance */
  inputRef,
  /** @description k-tooltip component instance */
  popperRef,
