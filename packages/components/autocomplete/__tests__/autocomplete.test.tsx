...
describe('Autocomplete.vue', () => {
  ...
  test('popperClass', async () => {
    ...
    expect(
      document.body.querySelector('.k-popper')?.classList.contains('error')
    ).toBe(true)
    ...
    expect(
      document.body.querySelector('.k-popper')?.classList.contains('success')
    ).toBe(true)
  })

  test('teleported', async () => {
    _mount({ teleported: false })
    expect(document.body.querySelector('.k-popper__mask')).toBeNull()
  })
  ...
  test('hideLoading', async () => {
    ...
    expect(document.body.querySelector('.k-icon-loading')).toBeDefined()
    await wrapper.setProps({ hideLoading: true })
    expect(document.body.querySelector('.k-icon-loading')).toBeNull()
  })
  ...
  test('fitInputWidth', async () => {
    ...
    const inputDom = wrapper.find('.k-input').element
  ...
  describe('test a11y supports', () => {
    test('test a11y attributes', async () => {
      ...
      const container = wrapper.find('.k-autocomplete')
