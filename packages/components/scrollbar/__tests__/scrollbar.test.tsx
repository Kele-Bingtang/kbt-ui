...
import makeScroll from '@kbt-ui/test-utils/make-scroll'
...
describe('ScrollBar', () => {
  test('vertical', async () => {
    ...
    const scrollDom = wrapper.find('.k-scrollbar__wrap').element
  ...
  test('should render always props', async () => {
    ...
    expect(wrapper.find('.k-scrollbar__bar').attributes('style')).toBeFalsy()
  })
  ...
  test('should render tag props', async () => {
    ...
    expect(
      wrapper.find('.k-scrollbar__view').element instanceof HTMLUListElement
    ).toBeTruthy()
  })
  ...
  test('should render wrap-class props', async () => {
    ...
    expect(wrapper.find('.k-scrollbar__wrap').classes()).toContain(wrapClass)
  })
  ...
  test('should render view-style props', async () => {
    ...
    expect(wrapper.find('.k-scrollbar__view').attributes('style')).toContain(
      viewStyle
    )
  })
  ...
  test('should render view-class props', async () => {
    ...
    expect(wrapper.find('.k-scrollbar__view').classes()).toContain(viewClass)
  })
})
