...
describe('Rate.vue', () => {
  it('create', () => {
    ...
    const stars = wrapper.findAll('.k-rate__item')
  ...
  it('size', async () => {
    ...
    expect(wrapper.find('.k-rate--large').exists()).toBe(true)
    await wrapper.setProps({ size: '' })
    expect(wrapper.find('.k-rate').exists()).toBe(true)
  })
  ...
  it('allow half', async () => {
    ...
    const secondStar = wrapper.findAll('.k-rate__item')[1]
  ...
  it('with texts', () => {
    ...
    const text = wrapper.find('.k-rate__text').element
  ...
  it('text color', () => {
    ...
    const text = wrapper.find('.k-rate__text').element as HTMLSpanElement
  ...
  it('click', () => {
    ...
    const thirdStar = wrapper.findAll('.k-rate__item')[2]
      .element as HTMLElement
    thirdStar.click()
  ...
  it('colors', () => {
    ...
    const rateK = wrapper.find('.k-rate').element as HTMLElement
    expect(rateK.style.getPropertyValue('--k-rate-fill-color')).toBe('#FF9900')
  })
  ...
  it('change event', () => {
    ...
    const fourthStar = wrapper.findAll('.k-rate__item')[3]
      .element as HTMLElement
    fourthStar.click()

    expect(value.value).toEqual(4)
    expect(changeCount.value).toEqual(0)
    const fifthStar = wrapper.findAll('.k-rate__item')[4]
      .element as HTMLElement
    fifthStar.click()
  ...
  it('show background icon when allow-half attribute is true', async () => {
    ...
    expect(wrapper.find('.k-rate__decimal--box').exists()).toBe(true)
    value.value = 3.4
    await nextTick()
    expect(wrapper.find('.k-rate__decimal--box').exists()).toBe(false)
  })
