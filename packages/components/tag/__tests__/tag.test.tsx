...
describe('Tag.vue', () => {
  test('render text & class', () => {
    ...
    expect(vm.$el.classList.contains('k-tag')).toEqual(true)
    expect(vm.$el.classList.contains('k-tag__close')).toEqual(false)
  ...
  test('type', () => {
    ...
    const vm = wrapper.vm
    expect(vm.$el.classList.contains('k-tag--success')).toEqual(true)
  })
  ...
  test('closable', async () => {
    ...
    const closeBtn = comp.find('.k-tag .k-tag__close')
  ...
  test('theme', () => {
    ...
    const vm = wrapper.vm
    const el = vm.$el
    expect(el.className.includes('k-tag--dark')).toEqual(true)
    expect(el.className.includes('k-tag--light')).toEqual(false)
    expect(el.className.includes('k-tag--plain')).toEqual(false)
  })
  ...
  test('size', () => {
    ...
    const vm = wrapper.vm
    const el = vm.$el
    expect(el.className.includes('k-tag--large')).toEqual(true)
    expect(el.className.includes('k-tag--default')).toEqual(false)
    expect(el.className.includes('k-tag--small')).toEqual(false)
  })
})
