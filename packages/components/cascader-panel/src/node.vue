<template>
  ...
  >
    ...
    <k-icon v-else-if="isLeaf && node.checked" :class="ns.e('prefix')">
      <check />
    </k-icon>
    ...
    <template v-if="!isLeaf">
      <k-icon v-if="node.loading" :class="[ns.is('loading'), ns.e('postfix')]">
        <loading />
      </k-icon>
      <k-icon v-else :class="['arrow-right', ns.e('postfix')]">
        <arrow-right />
      </k-icon>
    </template>
  </li>
...
import KRadio from '@kbt-ui/components/radio'
