...
import installStyle from '@kbt-ui/test-utils/style-plugin'
import {
  KCheckbox as Checkbox,
  KCheckboxGroup as CheckboxGroup,
...
import type { FormRules } from '@kbt-ui/components/form'
...
describe('Form', () => {
  ...
  it('label width', async () => {
    ...
    expect(findStyle(wrapper, '.k-form-item__label').width).toBe('80px')
  })
  ...
  it('auto label width', async () => {
    ...
    const formItems = wrapper.findAll<HTMLElement>('.k-form-item__content')
    ...
    const formItems1 = wrapper.findAll<HTMLElement>('.k-form-item__content')
  ...
  it('form-item auto label width', async () => {
    ...
    const formItemLabels = wrapper.findAll<HTMLElement>('.k-form-item__label')
    const formItemLabelWraps = wrapper.findAll<HTMLElement>(
      '.k-form-item__label-wrap'
    )
  ...
  it('inline form', () => {
    ...
    expect(wrapper.classes()).toContain('k-form--inline')
  })
  ...
  it('show message', async () => {
    ...
    expect(wrapper.find('.k-form-item__error').exists()).toBe(false)
  })
  ...
  it('reset field', async () => {
    ...
    expect(wrapper.findAll('.k-form-item__error')).toHaveLength(0)
    vi.useRealTimers()
  })
