...
describe('Loading', () => {
  ...
  test('create directive', async () => {
    ...
    const maskWrapper = wrapper.find('.k-loading-mask')
    ...
    vi.useRealTimers()
    await nextTick()
    expect(wrapper.find('.k-loading-mask').exists()).toBeFalsy()
  })
  ...
  test('unmounted directive', async () => {
    ...
    await nextTick()
    expect(document.querySelector('.k-loading-mask')).toBeFalsy()
  })
  ...
  test('lock directive', async () => {
    ...
    await nextTick()
    expect(
      document.body.classList.contains('k-loading-parent--hidden')
    ).toBeTruthy()
    loading.value = false
    document.body.removeChild(document.querySelector('.k-loading-mask')!)
  })
  ...
  test('text directive', async () => {
    ...
    await nextTick()
    expect(wrapper.find('.k-loading-text').text()).toEqual('loading...')
  })
  ...
  test('create service', async () => {
    ...
    expect(document.querySelector('.k-loading-mask')).toBeTruthy()
  })
  ...
  test('target service', async () => {
    ...
    const mask = container.querySelector('.k-loading-mask')!
    expect(mask).toBeTruthy()
    expect(mask.parentNode).toEqual(container)

    expect(
      container.classList.contains('k-loading-parent--relative')
    ).toBeTruthy()
  ...
  test('fullscreen singleton service', async () => {
    ...
    let masks = document.querySelectorAll('.k-loading-mask')
    ...
    masks = document.querySelectorAll('.k-loading-mask')
  ...
  test('text service', async () => {
    ...
    const text = document.querySelector('.k-loading-text')!
    expect(text).toBeTruthy()
    expect(text.textContent).toEqual('Loading...')
  })

  test('customClass service', async () => {
    loadingInstance = Loading({ customClass: 'k-loading-custom-class' })
    const customClass = document.querySelector('.k-loading-custom-class')
  ...
  test("parent's display is not block", async () => {
    ...
    const maskDisplay = getComputedStyle(
      wrapper.find('.k-loading-mask').element
    ).display
