      ...
      >
        ...
        <template v-if="!isSingle">
          <span :class="arrowPrevKls" @click="prev">
            <k-icon><ArrowLeft /></k-icon>
          </span>
          <span :class="arrowNextKls" @click="next">
            <k-icon><ArrowRight /></k-icon>
          </span>
        </template>
        <!-- ACTIONS -->
        <div :class="[ns.e('btn'), ns.e('actions')]">
          <div :class="ns.e('actions__inner')">
            <k-icon @click="handleActions('zoomOut')">
              <ZoomOut />
            </k-icon>
            <k-icon @click="handleActions('zoomIn')">
              <ZoomIn />
            </k-icon>
            <i :class="ns.e('actions__divider')" />
            <k-icon @click="toggleMode">
              <component :is="mode.icon" />
            </k-icon>
            <i :class="ns.e('actions__divider')" />
            <k-icon @click="handleActions('anticlockwise')">
              <RefreshLeft />
            </k-icon>
            <k-icon @click="handleActions('clockwise')">
              <RefreshRight />
            </k-icon>
          </div>
        </div>
...
import { useLocale, useNamespace, useZIndex } from '@kbt-ui/hooks'
import { EVENT_CODE } from '@kbt-ui/constants'
import { keysOf } from '@kbt-ui/utils'
