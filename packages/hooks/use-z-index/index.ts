...
import { debugWarn, isClient, isNumber } from '@kbt-ui/utils'

import type { InjectionKey, Ref } from 'vue'

export interface KZIndexInjectionContext {
  current: number
}

const initial: KZIndexInjectionContext = {
  current: 0,
}
...
// For SSR
export const ZINDEX_INJECTION_KEY: InjectionKey<KZIndexInjectionContext> =
