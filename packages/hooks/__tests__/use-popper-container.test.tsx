...
describe('no injection value', () => {
  ...
  it('usePopperContainerId', () => {
    ...
    expect(wrapper.vm.id).toMatch(/^k-popper-container-\d{0,4}$/)
    expect(wrapper.vm.selector).toMatch(/^#k-popper-container-\d{0,4}$/)
...
describe('with injection value', () => {
  ...
  it('usePopperContainerId', () => {
    ...
    expect(wrapper.vm.id).toBe('k-popper-container-1024')
    expect(wrapper.vm.selector).toBe('#k-popper-container-1024')
  })
})
