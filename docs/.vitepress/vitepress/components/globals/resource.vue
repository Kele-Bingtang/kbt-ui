...
const mirrorUrl = 'kbt-ui.gitee.io'
const isMirrorUrl = () => {
  if (!isClient) return
...
const resourceUrl = {
  ...
  gitee: {
    sketch:
      'https://gitee.com/kbt-ui/resources/raw/master/Element_Plus_Design_System_2022_1.0_Beta.zip',
    axure:
      'https://gitee.com/kbt-ui/resources/raw/master/Element_Components_v2.1.0.rplib',
  },
...
const resourceCards = computed(() => [
  {
    ...
    url: 'https://www.figma.com/community/file/1305760370797950824/kbt-ui-design-system-ui-kit',
  },
  {
    key: 'figma-variables',
    ...
    <div class="resource-content">
      ...
      >
        ...
        <a target="_blank" :href="card.url" @click="onClick(card.title)">
          <k-button type="primary">{{ resourceLang.download }}</k-button>
        </a>
      </k-card>
    </div>
  </div>
