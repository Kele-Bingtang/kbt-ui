  ...
  docsearch(
    Object.assign({}, userOptions, {
      ...
      getMissingResultsUrl({ query }: { query: string }) {
        return `https://github.com/kbt-ui/kbt-ui/issues/new?title=${encodeURIComponent(
...
.DocSearch {
  ...
  --docsearch-modal-shadow: var(--k-box-shadow);

  transition: background-color var(--k-transition-duration-fast);
