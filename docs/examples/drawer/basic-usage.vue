<template>
  ...
  <k-drawer v-model="drawer2" :direction="direction">
    ...
    <template #default>
      <div>
        <k-radio v-model="radio1" value="Option 1" size="large"
          >Option 1</k-radio
        >
        <k-radio v-model="radio1" value="Option 2" size="large"
          >Option 2</k-radio
        >
      </div>
    </template>
    <template #footer>
      <div style="flex: auto">
        ...
        <k-button type="primary" @click="confirmClick">confirm</k-button>
      </div>
    </template>
  </k-drawer>
</template>
