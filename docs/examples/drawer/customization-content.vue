<template>
  <k-button text @click="table = true">Open Drawer with nested table</k-button>
  <k-button text @click="dialog = true">Open Drawer with nested form</k-button>
  <k-drawer
    v-model="table"
...
import { KDrawer, KMessageBox } from 'kbt-ui'
...
const drawerRef = ref<InstanceType<typeof KDrawer>>()
const onClick = () => {
