...
import { TableV2FixedDir, TableV2Placeholder } from 'kbt-ui'
...
const headerClass = ({
  ...
  if (headerIndex === 1) return 'k-primary-color'
  return ''
}
</script>

<style>
.k-k-table-v2__header-row .custom-header-cell {
  border-right: 1px solid var(--k-border-color);
}

.k-k-table-v2__header-row .custom-header-cell:last-child {
  border-right: none;
}
...
.k-primary-color .custom-header-cell {
  padding: 0 4px;
}
</style>
