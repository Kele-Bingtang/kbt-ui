...
import { ref } from 'vue'
import { KButton, KCheckbox, KIcon, KPopover, TableV2FixedDir } from 'kbt-ui'
import { Filter } from '@element-plus/icons-vue'

import type { HeaderCellSlotProps } from 'kbt-ui'
...
columns[0].headerCellRenderer = (props: HeaderCellSlotProps) => {
  return (
    <div class="flex items-center justify-center">
      ...
      <KPopover ref={popoverRef} trigger="click" {...{ width: 200 }}>
        {{
          default: () => (
            <div class="filter-wrapper">
              <div class="filter-group">
                <KCheckbox v-model={shouldFilter.value}>Filter Text</KCheckbox>
              </div>
              <div class="k-table-v2__demo-filter">
                <KButton text onClick={onFilter}>
                  Confirm
                </KButton>
                <KButton text onClick={onReset}>
                  Reset
                </KButton>
              </div>
            </div>
