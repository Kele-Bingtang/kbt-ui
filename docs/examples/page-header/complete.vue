    ...
    <k-page-header @back="onBack">
      ...
      <template #content>
        <div class="flex items-center">
          ...
          <span class="text-sm mr-2" style="color: var(--k-text-color-regular)">
            Sub title
          </span>
          <k-tag>Default</k-tag>
        </div>
      ...
      <p class="mt-4 text-sm">
        Kbt UI team uses <b>weekly</b> release strategy under normal
...
import { KNotification as notify } from 'kbt-ui'
