...
You can checkout the allowed values for **type** and **scope** in [commitlint.config.js](https://github.com/kbt-ui/kbt-ui/blob/c2ee36a7fc72b17742d43ecdff4e2912c416141d/commitlint.config.js#L57),
