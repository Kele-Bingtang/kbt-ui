...
Use `css/scss` language to change the global or local color. We set some global color variables: `--k-rate-void-color`, `--k-rate-fill-color`, `--k-rate-disabled-void-color`, `--k-rate-text-color`. You can use like: `:root { --k-rate-void-color: red; --k-rate-fill-color: blue; }`.

### Default Variables

| Variable                     | Default Color                |
| ---------------------------- | ---------------------------- |
| --k-rate-void-color          | var(--k-border-color-darker) |
| --k-rate-fill-color          | #f7ba2a                      |
| --k-rate-disabled-void-color | var(--k-fill-color)          |
| --k-rate-text-color          | var(--k-text-color-primary)  |
