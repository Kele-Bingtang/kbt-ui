...
| accept                        | accepted [file types](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/input#attr-accept), will not work when `thumbnail-mode === true`.                                     | ^[string]                                                                                                                                  | ''                                                                                                     |
...
| http-request                  | override default xhr behavior, allowing you to implement your own upload-file's request.                                                                                              | ^[Function]`(options: UploadRequestOptions) => XMLHttpRequest \| Promise<unknown>`                                                         | ajaxUpload [see](https://github.com/kbt-ui/kbt-ui/blob/dev/packages/components/upload/src/ajax.ts#L55) |
