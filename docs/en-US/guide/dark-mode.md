...
After a long time, Kbt UI supports dark mode!
...
import 'kbt-ui/theme-chalk/dark/css-vars.css'
```

> If you want an example, you can refer to [kbt-ui-vite-starter](https://github.com/kbt-ui/kbt-ui-vite-starter).
...
Import it after styles of Kbt UI:
...
@forward 'kbt-ui/theme-chalk/src/dark/var.scss' with (
  $bg-color: (
    'page': #0a0a0a,
    '': #626aef,
    'overlay': #1d1e1f,
...
// import 'kbt-ui/theme-chalk/src/dark/css-vars.scss'
```
